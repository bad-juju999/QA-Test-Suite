...
Scenario: As a user I expect to be able to create a ticket
    ...
    //home.json file
{
    "employee email":"[id='take_command_employee__cloned_-input']",
      "team": "[id='internal_team_requestor__cloned_-input']"
}
//pages.json
,
      "ticketing": {
        "route": "https://share.hsforms.com/1kjjCLSTeTR-BBaQPlXjHbA1i82f"
      }
